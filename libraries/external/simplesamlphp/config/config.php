...
$config = array (
	 ...
	 * reverse proxy).
	 */
	'baseurlpath'           => 'saml/',		//efront modification
	'certdir'               => 'cert/',
	'loggingdir'            => 'log/',
	'datadir'               => 'data/',
	 ...
	 */
	'tempdir'               => sys_get_temp_dir(),		//efront modification
	 ...
	 */
	'auth.adminpassword'		=> $ef::$config['admin_hash'],		//efront modification
	 ...
	 */
	'secretsalt' => $ef::$config['salt'],	//efront modification
	 ...
	 */
	'technicalcontact_name'     => $ef::$config['admin_name'],
	'technicalcontact_email'    => $ef::$config['admin_email'],
	 ...
	 * syntaxes.
	 */
	'store.sql.dsn' => 'mysql::host='.$ef::$config['db_host'].';dbname='.$ef::$config['db_name'],

	/*
	 * The username and password to use when connecting to the database.
	 */
	'store.sql.username' => $ef::$config['db_user'],
	'store.sql.password' => $ef::$config['db_passwd'],
